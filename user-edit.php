        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <label for=""  class="text-success mt-1">Name</label>
                ...
                <div class="col-md-4 mt-3">
                    ...
                    <?php endif; ?>
                    <span class="text-success" style="font-size: 20px">If you want change avatar please choose photo</span>
                    <div class="custom-file">
                        <input type="file"  name="avatar" value="" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                    </div>
                </div>
                    <button class="btn btn-primary mt-5">Обновить</button>
                </form>
            </div>
        </div>
